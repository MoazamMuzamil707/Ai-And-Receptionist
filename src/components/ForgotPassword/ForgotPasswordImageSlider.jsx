...
const ForgotPasswordImageSlider = () => {
    return (
        <>
            <div className="col-lg-6">
                <div className="p-lg-5 p-4 auth-one-bg h-100">
                    ...
                    <div className="position-relative h-100 d-flex flex-column">
                        <div className="mb-4">
                            <Link href="index.html" className="d-block">
                        ...
                        <div className="mt-auto">
                            ...
                            <div id="qoutescarouselIndicators" className="carousel slide" data-bs-ride="carousel">
                                ...
                                <div className="carousel-inner text-center text-white-50 pb-5">
                                    ...
                                    <div className="carousel-item">
                                        <p className="fs-15 fst-italic">" Great! Clean code, clean design, easy for customization.
                                            Thanks very much! "</p>
                                    </div> */}
                                </div>
                            </div>
...
export default ForgotPasswordImageSlider;