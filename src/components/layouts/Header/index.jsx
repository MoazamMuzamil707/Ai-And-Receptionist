...
const HeaderComponent = ({ onChangeLayoutMode, layoutModeType, headerClass }) => {
    ...
    return (
        <>
            <div id="page-topbar" className={` ${headerClass}`}>
                            ...
                            <div className="navbar-brand-box horizontal-logo">
                                <Link href="/" className="logo logo-dark">
                                    <span className="logo-sm">
                                        <img src={"@public/assets/images/logo-m3.png"} alt="" height="22" />
                                    </span>
                                    <span className="logo-lg">
                                        <img src={"@public/assets/images/logo-m3.png"} alt="" height="17" />
                                    </span>
                                </Link>
