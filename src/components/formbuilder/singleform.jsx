...
import { createValidationSchema, validateFormData } from '@/lib/helpers/validation';

const SingleForm = ({ name, formConfig, onSubmit, buttonText, formType, endpoint, selectedData, mode, setModal, setSuccessModal }) => {
